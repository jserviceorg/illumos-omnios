...
#
# Customisation for Devuan-based distributions.  Assumes to have been
# sourced from lx_boot.
#

tmpfile=/tmp/lx-devuan.$$
...
# The Devuan init uses a combination of traditional rc-style service
...
#
# We need to setup for the /dev/shm mount. Unlike some other distros, Devuan
